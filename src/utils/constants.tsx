...
export const currentlyTrendingGamesItems = [
    ...
    {
        thumbnail: game2Image,
        name: "Red Dead Redemption 2",
        followers: "40 Followers"
    },
    {
        thumbnail: game3Image,
        name: "Monster Hunter World",
        followers: "40 Followers"
    },
    {
        thumbnail: game4Image,
        name: "The Last Of Us: Part I",
        followers: "40 Followers"
    },
    {
        thumbnail: game5Image,
        name: "Diablo IV",
        followers: "40 Followers"
    }
];

export const gameDistributorItems = [
    {
        title: "Exclusive Catalog",
        description:
            "Explore a unique collection of games, from classics to the latest releases, carefully curated for true gamers."
    },
    {
        title: "Irresistible Deals",
        description:
            "Take advantage of special discounts on our wide selection of titles, ensuring you can expand your game library without breaking the bank."
    },
    {
        title: "Exclusive Pre-orders",
        description:
            "Be the first to experience the most anticipated gaming titles with our exclusive pre-orders, providing early access to the hottest releases."
    },
    {
